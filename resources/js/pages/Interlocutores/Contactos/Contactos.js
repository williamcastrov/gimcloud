 ...
 */
  ...
  const contactoInsertar = (
    <div className={styles.modal}>
      ...
      <br /><br />
      <div align="right">
        <Button color="primary" onClick={() => grabarContacto()} >Insertar</Button>
  ...
  const contactoEditar = (
    <div className={styles.modal}>
      ...
      <br />
      <div align="right">
        <Button color="primary" onClick={() => actualizarContacto()} >Editar</Button>
  ...
  const contactoEliminar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button color="secondary" onClick={() => borrarContacto()}> Confirmar </Button>
