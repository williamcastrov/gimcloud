...
import tiposmttoServices from "../../../services/Parameters/Tiposmtto";
 ...
 // "string","boolean","numeric","date","datetime","time","currency"
  ...
  const tipomttoInsertar=(
    <div className={styles.modal}>
      <h3>Agregar Nuevo Tipo de Mantenimiento</h3>
  ...
  return (
    <div className="App">
    <Button onClick={()=> abrirCerrarModalInsertar() } >Insertar Tipo de Mantenimiento</Button>
     <MaterialTable
       columns={columnas}
       data={listTiposmtto}
