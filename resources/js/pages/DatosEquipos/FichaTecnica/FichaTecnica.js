  ...
  const fichatecnicaInsertar = (
    <div className={styles.modal}>
      ...
      <Grid container spacing={2} >
        ...
        <Grid item xs={12} md={3}> <TextField name="codigoinventario_fit" label="Código Inventario"
          fullWidth onChange={handleChange} />
        </Grid>
        ...
        <Grid item xs={12} md={3}> <TextField name="separacionbrazos_fit" label="Separación de los Brazos"
          fullWidth onChange={handleChange} />
        </Grid>
        <Grid item xs={12} md={3}> <TextField name="medidacofrebateria_fit" label="Medidas del Cofre de la Bateria"
          fullWidth onChange={handleChange} />
        </Grid>
        <Grid item xs={12} md={4}> <TextField name="denominacion_fit" label="Denominación"
          fullWidth onChange={handleChange} />
        </Grid>
        ...
        <Grid item xs={12} md={6}> <TextField name="bateriatraccion_fit" label="Información de la Bateria del Equipo"
          fullWidth onChange={handleChange} />
        </Grid>
        <Grid item xs={12} md={6}> <TextField name="cargador_fit" label="Información del Cargador de la Bateria"
          fullWidth onChange={handleChange} />
        </Grid>
