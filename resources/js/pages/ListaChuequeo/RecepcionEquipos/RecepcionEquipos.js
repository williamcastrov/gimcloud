...
function RecepcionEquipos() {
  ...
  useEffect(() => {
    async function fetchDataRecepcionEquipos() {
      const res = await recepcionequiposServices.listRecepcionEquipos();
  ...
  const RecepcionEquiposInsertar = (
    <div className={styles.modal}>
      <Typography align="center" className={styles.typography} variant="button" display="block">Agregar Item Recepción Equipos</Typography>
      <br />
...
//value={recepcionEquiposSeleccionado && recepcionEquiposSeleccionado.id_alm} 
  const RecepcionEquiposEditar = (
    <div className={styles.modal}>
      <Typography align="center" className={styles.typography} variant="button" display="block">Actualizar Item Recepción Equipos</Typography>
      <br />
      <Grid container spacing={2} >
        <Grid item xs={12} md={12}>
           <FormControl className={styles.formControl}>
  ...
  return (
    <div className="App">
      ...
      <MaterialTable
        ...
        title="LISTA DE CHEQUEO RECEPCION DE EQUIPOS"
        actions={[
          {
            icon: 'edit',
...
export default RecepcionEquipos;