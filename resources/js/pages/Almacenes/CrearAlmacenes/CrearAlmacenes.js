...
function CrearAlmacenes() {
  ...
  const AlmacenInsertar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button color="primary" onClick={() => grabarAlmacen()} >Insertar</Button>
  ...
  const AlmacenEditar = (
    <div className={styles.modal}>
      ...
      <br />
      <div align="right">
        <Button color="primary" onClick={() => actualizarAlmacen()} >Editar</Button>
  ...
  const AlmacenEliminar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button color="secondary" onClick={() => borrarAlmacen()}> Confirmar </Button>
