...
function LineasProductos() {
  ...
  const lineaProductoInsertar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button color="primary" onClick={() => grabarLineaProducto()} >Insertar</Button>
  ...
  const lineaProductoEditar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button color="primary" onClick={() => actualizarLineaProducto()} >Editar</Button>
  ...
  const lineaProductoEliminar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button color="secondary" onClick={() => borrarLineaProducto()}> Confirmar </Button>
