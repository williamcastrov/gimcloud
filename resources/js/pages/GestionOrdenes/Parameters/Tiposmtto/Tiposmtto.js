...
function Tiposmtto() {
  ...
  const tipomttoInsertar = (
    <div className={styles.modal}>
      <Typography align="center" className={styles.typography} variant="button" display="block">Agregar Tipo de Mantenimiento</Typography>
  ...
  const tipomttoEditar = (
    <div className={styles.modal}>
       <Typography align="center" className={styles.typography} variant="button" display="block">Actualizar Tipo de Mantenimiento</Typography>
