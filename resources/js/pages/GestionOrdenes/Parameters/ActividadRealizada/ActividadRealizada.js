 ...
 // "string","boolean","numeric","date","datetime","time","currency"
  ...
  const actividadRealizadaInsertar=(
    <div className={styles.modal}>
      ...
      <br /><br />
      <div align="right">    
        <Button color="primary" onClick = { () => grabarActividadRealizada() } >Insertar</Button>
  ...
  const actividadRealizadaEditar = (
    <div className={styles.modal}>
      ...
      <br /><br />
      <div align="right">
        <Button color="primary"  onClick={()=>actualizarActividadRealizada()} >Editar</Button>
  ...
  const actividadRealizadaEliminar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button color="secondary" onClick = {() => borrarActividadRealizada() }> Confirmar </Button>
