...
function TipoOperacion() {
  ...
  const tipooperacionInsertar = (
    <div className={styles.modal}>
      ...
      <br />
      <div align="right">
        <Button color="primary" onClick={() => grabarTipoOperacion()} >Insertar</Button>
  ...
  const tipooperacionEditar = (
    <div className={styles.modal}>
      ...
      <br /><br />
      <div align="right">
        <Button color="primary" onClick={() => actualizarTipoOperacion()} >Editar</Button>
  ...
  const tipooperacionEliminar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button color="secondary" onClick={() => borrarTipoOperacion()}> Confirmar </Button>
