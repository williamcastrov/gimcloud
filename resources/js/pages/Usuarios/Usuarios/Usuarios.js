...
function Usuarios() {
  ...
  useEffect(() => {
    async function fetchDataEmpresa() {
      const res = await empresaServices.listUsuarios();
      setListUsuarios(res.data);
    }
    setActualiza(false);
    fetchDataEmpresa();
...
/*
  useEffect(() => {
    function fetchActualizaUsuario() {
      setUsuarioSeleccionado([{
        cedula_usu: usuariosSeleccionado.cedula_usu,
        nombre_usu: usuariosSeleccionado.nombre_usu,
        email_usu: email,
        pais_usu: usuariosSeleccionado.pais_usu,
        ciudad_usu: usuariosSeleccionado.ciudad_usu,
        uidfirebase_usu: uid,
        tipo_usu: usuariosSeleccionado.tipo_usu,
        foto_usu: '',
        celular_usu: usuariosSeleccionado.celular_usu, 
        estado_usu: usuariosSeleccionado.estado_usu 
      }]);
      
    }
    fetchActualizaUsuario();
  }, [grabar])
*/
  /*
...
*/
  const grabarUsuario = async () => {
    ...
    //console.log("UID : ", uid)
    //console.log("DATOS GRABAR : ", usuariosSeleccionado);
