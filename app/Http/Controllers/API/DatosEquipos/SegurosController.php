...
class SegurosController extends Controller
{
    ...
    public function get($IDinterno_seg){
        ...
        try {    
            ...
            FROM seguros as t0 INNER JOIN estados            as t1 INNER JOIN equipos  as t2 
                               INNER JOIN interlocutores_cli as t3 INNER JOIN ciudades as t4
            WHERE t0.estado_seg = t1.id_est and t0.equipo_seg = t2.id_equ and t0.clienteubicacion_seg = t3.id_cli 
              and t0.ciudad_seg = t4.id_ciu and t0.IDinterno_seg = $IDinterno_seg");
    ...
    public function update(Request $request, $IDinterno_seg){
          ...
          try {
            ...
            $res = Seguros::where("IDinterno_seg",$IDinterno_seg)->update($data);
        ...
        public function delete($IDinterno_seg){
  
          try {
            $res = Seguros::where("IDinterno_seg",$IDinterno_seg)->delete($IDinterno_seg);
            $response['res'] = $res;
